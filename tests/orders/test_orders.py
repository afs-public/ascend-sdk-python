...
def test_orders_orders_create_order_create_order1(
    create_order_id,
):
    assert create_order_id is not None


def test_orders_orders_get_order_get_order1(
    ...
    res = s.orders.get_order(account_id=enrolled_account_id, order_id=create_order_id)
