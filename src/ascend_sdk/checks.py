...
class Checks(BaseSDK):
    def get_check_deposit(
        ...
        *,
    ...
    ) -> operations.CheckDepositsGetCheckDepositResponse:
        r"""Get Check Deposit
        ...
        request = operations.CheckDepositsGetCheckDepositRequest(
        ...
        req = self._build_request(
            method="GET",
            path="/transfers/v1/accounts/{account_id}/checkDeposits/{checkDeposit_id}",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="CheckDeposits_GetCheckDeposit",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.CheckDepositsGetCheckDepositResponse(
    ...
    async def get_check_deposit_async(
        self,
        *,
        account_id: str,
        check_deposit_id: str,
