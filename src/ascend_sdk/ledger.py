        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.LedgerListEntriesResponse(
                list_entries_response=unmarshal_json_response(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.LedgerListActivitiesResponse(
                list_activities_response=unmarshal_json_response(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.LedgerListPositionsResponse(
                list_positions_response=unmarshal_json_response(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.LedgerGetActivityResponse(
                activity=unmarshal_json_response(
                    Optional[components.Activity], http_res
                ),
                http_meta=components.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, ["400", "403"], "application/json"):
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.LedgerGetEntryResponse(
                entry=unmarshal_json_response(Optional[components.Entry], http_res),
                http_meta=components.HTTPMetadata(request=req, response=http_res),
            )
        if utils.match_response(http_res, ["400", "403"], "application/json"):
            response_data = unmarshal_json_response(errors.StatusData, http_res)
