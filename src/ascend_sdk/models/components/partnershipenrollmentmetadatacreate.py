...
class PartnershipEnrollmentMetadataCreateDividendReinvestmentPlan(
...
class PartnershipEnrollmentMetadataCreateFdicCashSweep(
    str, Enum, metaclass=utils.OpenEnumMeta
):
...
class PartnershipEnrollmentMetadataCreateMoneyMarketFundSweep(
    str, Enum, metaclass=utils.OpenEnumMeta
):
...
class PartnershipEnrollmentMetadataCreateTypedDict(TypedDict):
    ...
    fdic_cash_sweep: NotRequired[PartnershipEnrollmentMetadataCreateFdicCashSweep]
    r"""Option to auto-enroll in FDIC cash sweep; defaults to FDIC_CASH_SWEEP_ENROLL"""
...
class PartnershipEnrollmentMetadataCreate(BaseModel):
    r"""Enrollment metadata for the PARTNERSHIP enrollment type"""

    dividend_reinvestment_plan: Annotated[
        Optional[PartnershipEnrollmentMetadataCreateDividendReinvestmentPlan],
    ...
    fdic_cash_sweep: Annotated[
        Optional[PartnershipEnrollmentMetadataCreateFdicCashSweep],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""Option to auto-enroll in FDIC cash sweep; defaults to FDIC_CASH_SWEEP_ENROLL"""

    money_market_fund_sweep: Annotated[
        Optional[PartnershipEnrollmentMetadataCreateMoneyMarketFundSweep],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""Option to auto-enroll in Money Market Fund Sweep; defaults to MONEY_MARKET_FUND_SWEEP_ENROLL"""
