...
class CustodialIRARothEnrollmentMetadataCreateDividendReinvestmentPlan(
...
class CustodialIRARothEnrollmentMetadataCreateFdicCashSweep(
    str, Enum, metaclass=utils.OpenEnumMeta
):
...
class CustodialIRARothEnrollmentMetadataCreateTypedDict(TypedDict):
    ...
    r"""Option to auto-enroll in Dividend Reinvestment; defaults to DIVIDEND_REINVESTMENT_ENROLL"""
    fdic_cash_sweep: NotRequired[CustodialIRARothEnrollmentMetadataCreateFdicCashSweep]
    r"""Option to auto-enroll in FDIC cash sweep; defaults to FDIC_CASH_SWEEP_ENROLL"""


class CustodialIRARothEnrollmentMetadataCreate(BaseModel):
    r"""Enrollment metadata for the REGISTRATION_CUSTODIAL_IRA_ROTH enrollment type"""

    dividend_reinvestment_plan: Annotated[
        Optional[CustodialIRARothEnrollmentMetadataCreateDividendReinvestmentPlan],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""Option to auto-enroll in Dividend Reinvestment; defaults to DIVIDEND_REINVESTMENT_ENROLL"""

    fdic_cash_sweep: Annotated[
        Optional[CustodialIRARothEnrollmentMetadataCreateFdicCashSweep],
        PlainValidator(validate_open_enum(False)),
    ] = None
    r"""Option to auto-enroll in FDIC cash sweep; defaults to FDIC_CASH_SWEEP_ENROLL"""
