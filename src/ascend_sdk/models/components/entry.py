...
class Capacity(str, Enum, metaclass=utils.OpenEnumMeta):
...
class OptionContractQuantityTypedDict(TypedDict):
...
class OptionContractQuantity(BaseModel):
    r"""Records the number of contracts exercised or assigned"""
...
class AssignmentTypedDict(TypedDict):
    ...
    option_contract_quantity: NotRequired[Nullable[OptionContractQuantityTypedDict]]
    r"""Records the number of contracts exercised or assigned"""
...
class Assignment(BaseModel):
    ...
    capacity: Annotated[
        Optional[Capacity], PlainValidator(validate_open_enum(False))
    ] = None
    r"""Trade capacity type"""
    ...
    option_contract_quantity: OptionalNullable[OptionContractQuantity] = UNSET
    r"""Records the number of contracts exercised or assigned"""
...
class EntryCapacity(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""Trade capacity type"""
...
class ExerciseType(str, Enum, metaclass=utils.OpenEnumMeta):
...
class EntryOptionContractQuantityTypedDict(TypedDict):
    r"""Records the number of contracts exercised or assigned"""
...
class EntryOptionContractQuantity(BaseModel):
    r"""Records the number of contracts exercised or assigned"""
...
class ExerciseTypedDict(TypedDict):
    ...
    capacity: NotRequired[EntryCapacity]
    r"""Trade capacity type"""
    exercise_type: NotRequired[ExerciseType]
    r"""Exercise type classification"""
    option_asset_id: NotRequired[str]
    r"""Records the asset_id of the option that was exercised or assigned"""
    option_contract_quantity: NotRequired[
        Nullable[EntryOptionContractQuantityTypedDict]
    ]
    r"""Records the number of contracts exercised or assigned"""
    option_description: NotRequired[str]
    r"""Records the description of the option the account exercised or assigned"""
...
class Exercise(BaseModel):
    ...
    capacity: Annotated[
        Optional[EntryCapacity], PlainValidator(validate_open_enum(False))
    ] = None
    r"""Trade capacity type"""

    exercise_type: Annotated[
        Optional[ExerciseType], PlainValidator(validate_open_enum(False))
    ] = None
    r"""Exercise type classification"""
    ...
    option_contract_quantity: OptionalNullable[EntryOptionContractQuantity] = UNSET
    r"""Records the number of contracts exercised or assigned"""
...
class Moneyness(str, Enum, metaclass=utils.OpenEnumMeta):
...
class ExpirationTypedDict(TypedDict):
    ...
    moneyness: NotRequired[Moneyness]
    r"""Indicates whether the price of the underlying was above or below the strike price of the option"""
...
class Expiration(BaseModel):
    ...
    moneyness: Annotated[
        Optional[Moneyness], PlainValidator(validate_open_enum(False))
    ] = None
    r"""Indicates whether the price of the underlying was above or below the strike price of the option"""
...
class OptionAdjustmentTypedDict(TypedDict):
    r"""Object containing metadata for option adjustments"""
...
class OptionAdjustment(BaseModel):
    r"""Object containing metadata for option adjustments"""
...
class EntryDistributionType(str, Enum, metaclass=utils.OpenEnumMeta):
...
class WithdrawalTypedDict(TypedDict):
    ...
    distribution_type: NotRequired[EntryDistributionType]
    r"""Provides information on the reason for the distribution from a retirement account"""
...
class Withdrawal(BaseModel):
    ...
    distribution_type: Annotated[
        Optional[EntryDistributionType], PlainValidator(validate_open_enum(False))
    ] = None
    r"""Provides information on the reason for the distribution from a retirement account"""
...
class EntryTypedDict(TypedDict):
    ...
    assignment: NotRequired[Nullable[AssignmentTypedDict]]
    r"""When booked with a type of MOVEMENT, this subtype will remove an options position due to assignment. When booked with a type of TRADE, this subtype records the purchase/ sale of the underlying asset from the assignment of an options position"""
    ...
    r"""Used to record the exchange of certificates for a new security or cash and details related to the exchange"""
    exercise: NotRequired[Nullable[ExerciseTypedDict]]
    r"""When booked with a type of MOVEMENT, this subtype will remove an options position due to exercise. When booked with a type of TRADE, this subtype records the purchase/ sale of the underlying asset from exercising an options position"""
    expiration: NotRequired[Nullable[ExpirationTypedDict]]
    r"""Used to record the removal of positions in options assets that have reached or passed their expiration date and expired worthless"""
    ...
    r"""Used to record changes in the name of a security/securities by the issuer which result in surrendering physical securities or the assigning of a new security identifier which result in new securities being issued and details related to the name changes"""
    option_adjustment: NotRequired[Nullable[OptionAdjustmentTypedDict]]
    r"""Object containing metadata for option adjustments"""
...
class Entry(BaseModel):
    ...
    assignment: OptionalNullable[Assignment] = UNSET
    r"""When booked with a type of MOVEMENT, this subtype will remove an options position due to assignment. When booked with a type of TRADE, this subtype records the purchase/ sale of the underlying asset from the assignment of an options position"""
    ...
    exercise: OptionalNullable[Exercise] = UNSET
    r"""When booked with a type of MOVEMENT, this subtype will remove an options position due to exercise. When booked with a type of TRADE, this subtype records the purchase/ sale of the underlying asset from exercising an options position"""

    expiration: OptionalNullable[Expiration] = UNSET
    r"""Used to record the removal of positions in options assets that have reached or passed their expiration date and expired worthless"""
    ...
    option_adjustment: OptionalNullable[OptionAdjustment] = UNSET
    r"""Object containing metadata for option adjustments"""
