...
from ascend_sdk.models.components import (
    ...
    listactivitiesresponse as components_listactivitiesresponse,
...
class LedgerListActivitiesRequestTypedDict(TypedDict):
    account_id: str
    r"""The account id."""
    page_size: NotRequired[int]
    r"""The maximum number of activities to return. The service may return fewer than this value Default is 100 (subject to change) The maximum is 1000, values exceeding this will be set to 1000 (subject to change)"""
...
class LedgerListActivitiesResponseTypedDict(TypedDict):
    ...
    list_activities_response: NotRequired[
        components_listactivitiesresponse.ListActivitiesResponseTypedDict
    ]
    r"""OK"""
...
class LedgerListActivitiesResponse(BaseModel):
    next: Callable[[], Optional[LedgerListActivitiesResponse]]

    http_meta: Annotated[
        Optional[components_httpmetadata.HTTPMetadata], pydantic.Field(exclude=True)
    ] = None

    list_activities_response: Optional[
        components_listactivitiesresponse.ListActivitiesResponse
    ] = None
    r"""OK"""
