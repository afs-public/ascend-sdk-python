...
from ascend_sdk.models.components import (
    ...
    listaccountordersresponse as components_listaccountordersresponse,
...
class OrderServiceListAccountOrdersRequestTypedDict(TypedDict):
    account_id: str
    r"""The account id."""
    ...
    r"""The token for the next page of content to fetch. When paginating, all other parameters provided to `ListAccountOrders` must match the call that provided the page token."""


class OrderServiceListAccountOrdersRequest(BaseModel):
...
class OrderServiceListAccountOrdersResponseTypedDict(TypedDict):
    http_meta: components_httpmetadata.HTTPMetadataTypedDict
    list_account_orders_response: NotRequired[
        components_listaccountordersresponse.ListAccountOrdersResponseTypedDict
    ]
    r"""OK"""
...
class OrderServiceListAccountOrdersResponse(BaseModel):
    http_meta: Annotated[
        Optional[components_httpmetadata.HTTPMetadata], pydantic.Field(exclude=True)
    ] = None

    list_account_orders_response: Optional[
        components_listaccountordersresponse.ListAccountOrdersResponse
    ] = None
    r"""OK"""
