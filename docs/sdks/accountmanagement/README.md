...
* [update_account_group](#update_account_group) - Update Account Group
...
* [create_note](#create_note) - Create Note (Account)
* [list_notes](#list_notes) - List Notes (Account)
* [get_note](#get_note) - Get Note (Account)
...
with SDK(
    ...
    res = sdk.account_management.update_account(account_id="01HC3MAQ4DR9QN1V8MJ4CN1HMK", account_request_update={}, update_mask="[object Object]")
...
<!-- UsageSnippet language="python" operationID="Accounts_UpdateAccountGroup" method="put" path="/accounts/v1/accounts/{account_id}:updateAccountGroup" -->
```python
from ascend_sdk import SDK
from ascend_sdk.models import components
...
with SDK(
    ...
    res = sdk.account_management.update_account_group(account_id="01HC3MAQ4DR9QN1V8MJ4CN1HMK", update_account_group_request_update={})
...
| -------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| `account_id`                                                                                             | *str*                                                                                                    | :heavy_check_mark:                                                                                       | The account id.                                                                                          | 01HC3MAQ4DR9QN1V8MJ4CN1HMK                                                                               |
| `update_account_group_request_update`                                                                    | [components.UpdateAccountGroupRequestUpdate](../../models/components/updateaccountgrouprequestupdate.md) | :heavy_check_mark:                                                                                       | N/A                                                                                                      |                                                                                                          |
| `retries`                                                                                                | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)                                         | :heavy_minus_sign:                                                                                       | Configuration to override the default retry behavior of the client.                                      |                                                                                                          |

### Response

**[operations.AccountsUpdateAccountGroupResponse](../../models/operations/accountsupdateaccountgroupresponse.md)**
...
with SDK(
    ...
    res = sdk.account_management.update_party(account_id="01HC3MAQ4DR9QN1V8MJ4CN1HMK", party_id="a58ddb02-3954-4249-a7d5-1d408def12cf", party_request_update={}, update_mask="[object Object]")
...
with SDK(
    ...
    res = sdk.account_management.update_trusted_contact(account_id="01HC3MAQ4DR9QN1V8MJ4CN1HMK", trusted_contact_id="8096110d-fb55-4f9d-b883-b84f0b70d3ea", trusted_contact_update={}, update_mask="[object Object]")
...
| `update_mask`                                                                                                                                                                                                                                                                                  | *Optional[str]*                                                                                                                                                                                                                                                                                | :heavy_minus_sign:                                                                                                                                                                                                                                                                             | The list of fields to update. Updatable Fields  `given_name`  `middle_names`  `family_name`  `phone_number`  `email_address`  `mailing_address.region_code`  `mailing_address.postal_code`  `mailing_address.administrative_area`  `mailing_address.locality`  `mailing_address.address_lines` | {<br/>"update_mask": "given_name,middle_names"<br/>}                                                                                                                                                                                                                                           |
| `retries`                                                                                                                                                                                                                                                                                      | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)                                                                                                                                                                                                                               | :heavy_minus_sign:                                                                                                                                                                                                                                                                             | Configuration to override the default retry behavior of the client.                                                                                                                                                                                                                            |                                                                                                                                                                                                                                                                                                |
...
with SDK(
    ...
    res = sdk.account_management.update_interested_party(account_id="01HC3MAQ4DR9QN1V8MJ4CN1HMK", interested_party_id="ecf44f2f-7030-48ed-b937-c40891ee10c8", interested_party_update={}, update_mask="[object Object]")
...
<!-- UsageSnippet language="python" operationID="Accounts_CreateNote" method="post" path="/accounts/v1/accounts/{account_id}/notes" -->
```python
from ascend_sdk import SDK
from ascend_sdk.models import components
...
with SDK(
    ...
    res = sdk.account_management.create_note(account_id="01HC3MAQ4DR9QN1V8MJ4CN1HMK", note_create={
...
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `account_id`                                                        | *str*                                                               | :heavy_check_mark:                                                  | The account id.                                                     | 01HC3MAQ4DR9QN1V8MJ4CN1HMK                                          |
| `note_create`                                                       | [components.NoteCreate](../../models/components/notecreate.md)      | :heavy_check_mark:                                                  | N/A                                                                 |                                                                     |
| `retries`                                                           | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)    | :heavy_minus_sign:                                                  | Configuration to override the default retry behavior of the client. |                                                                     |

### Response

**[operations.AccountsCreateNoteResponse](../../models/operations/accountscreatenoteresponse.md)**
...
<!-- UsageSnippet language="python" operationID="Accounts_ListNotes" method="get" path="/accounts/v1/accounts/{account_id}/notes" -->
```python
from ascend_sdk import SDK
from ascend_sdk.models import components
...
with SDK(
    ...
    res = sdk.account_management.list_notes(account_id="01HC3MAQ4DR9QN1V8MJ4CN1HMK", page_size=50, page_token="eyJvZmZzZXQiOjUwfQ==", order_by="create_time desc")

    assert res.list_notes_response is not None

    # Handle response
    print(res.list_notes_response)
...
| ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
| `account_id`                                                                         | *str*                                                                                | :heavy_check_mark:                                                                   | The account id.                                                                      | 01HC3MAQ4DR9QN1V8MJ4CN1HMK                                                           |
| `page_size`                                                                          | *Optional[int]*                                                                      | :heavy_minus_sign:                                                                   | The maximum number of notes to return. The service may return fewer than this value. | 50                                                                                   |
| `page_token`                                                                         | *Optional[str]*                                                                      | :heavy_minus_sign:                                                                   | A page token, received from a previous `ListNotes` call.                             | eyJvZmZzZXQiOjUwfQ==                                                                 |
| `order_by`                                                                           | *Optional[str]*                                                                      | :heavy_minus_sign:                                                                   | The order in which notes are listed. Supported fields: `create_time`.                | create_time desc                                                                     |
| `retries`                                                                            | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)                     | :heavy_minus_sign:                                                                   | Configuration to override the default retry behavior of the client.                  |                                                                                      |

### Response

**[operations.AccountsListNotesResponse](../../models/operations/accountslistnotesresponse.md)**
...
<!-- UsageSnippet language="python" operationID="Accounts_GetNote" method="get" path="/accounts/v1/accounts/{account_id}/notes/{note_id}" -->
```python
from ascend_sdk import SDK
from ascend_sdk.models import components
...
with SDK(
    ...
    res = sdk.account_management.get_note(account_id="01HC3MAQ4DR9QN1V8MJ4CN1HMK", note_id="8096110d-fb55-4f9d-b883-b84f0b70d3ea")
...
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `account_id`                                                        | *str*                                                               | :heavy_check_mark:                                                  | The account id.                                                     | 01HC3MAQ4DR9QN1V8MJ4CN1HMK                                          |
| `note_id`                                                           | *str*                                                               | :heavy_check_mark:                                                  | The note id.                                                        | 8096110d-fb55-4f9d-b883-b84f0b70d3ea                                |
| `retries`                                                           | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)    | :heavy_minus_sign:                                                  | Configuration to override the default retry behavior of the client. |                                                                     |

### Response

**[operations.AccountsGetNoteResponse](../../models/operations/accountsgetnoteresponse.md)**
